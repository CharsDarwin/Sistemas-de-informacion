    ...
    public partial class frmCategories : Form
    {
        ...
        private void btnADD_Click(object sender, EventArgs e)
        {
            ...
            if(success==true)
            {
                ...
                Translator.TranslateGrid(dgvCategories);
            }
            else
            {
        ...
        private void dgvCategories_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            txtCategoryID.Text = dgvCategories.Rows[RowIndex].Cells["id"].Value.ToString();
            txtTitle.Text = dgvCategories.Rows[RowIndex].Cells["title"].Value.ToString();
            txtDescription.Text = dgvCategories.Rows[RowIndex].Cells["description"].Value.ToString();
        }
