    ...
    public partial class frmUsers : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            dgvUsers.DataSource = dt;
                Translator.TranslateGrid(dgvUsers);
        }
        ...
        private void dgvUsers_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            txtUserID.Text = dgvUsers.Rows[rowIndex].Cells["id"].Value.ToString();
            txtFirstName.Text = dgvUsers.Rows[rowIndex].Cells["first_name"].Value.ToString();
            txtLastName.Text = dgvUsers.Rows[rowIndex].Cells["last_name"].Value.ToString();
            ...
            cmbGender.Text = dgvUsers.Rows[rowIndex].Cells["gender"].Value.ToString();
            cmbUserType.Text = dgvUsers.Rows[rowIndex].Cells["user_type"].Value.ToString();
        }
