    ...
    class userDAL
    {
        ...
        public DataTable Select()
        {
            ...
            try
            {
                ...
                String sql = "SELECT u.id, u.first_name, u.last_name, u.email, u.username, u.password, u.contact, u.address, u.gender, u.user_type, u.added_date, u2.username AS added_by FROM tbl_users u LEFT JOIN tbl_users u2 ON u.added_by = u2.id";
        ...
        public DataTable Search(string keywords)
        {
            ...
            {
                //SQL Query to Get Data From DAtabase
                String sql = "SELECT u.id, u.first_name, u.last_name, u.email, u.username, u.password, u.contact, u.address, u.gender, u.user_type, u.added_date, u2.username AS added_by FROM tbl_users u LEFT JOIN tbl_users u2 ON u.added_by = u2.id WHERE u.id LIKE '%"+keywords+"%' OR u.first_name LIKE '%"+keywords+"%' OR u.last_name LIKE '%"+keywords+"%' OR u.username LIKE '%"+keywords+"%'";
                //For Executing Command
                SqlCommand cmd = new SqlCommand(sql, conn);
                //Getting DAta from dAtabase
                SqlDataAdapter adapter = new SqlDataAdapter(cmd);
